...
SELECT
    ...
    Sales,
    SUM(Sales) OVER(
    PARTITION BY OrderStatus ORDER BY OrderDate ROWS BETWEEN CURRENT ROW AND 2 FOLLOWING) AS total_sales
FROM Sales.Orders
...
SELECT
    ...
    Sales,
    SUM(Sales) OVER(
    PARTITION BY OrderStatus ORDER BY OrderDate ROWS BETWEEN 2 PRECEDING AND CURRENT ROW) AS total_sales
FROM Sales.Orders
...
SELECT
    ...
    Sales,
    SUM(Sales) OVER(
    PARTITION BY OrderStatus ORDER BY OrderDate ROWS 2 PRECEDING) AS total_sales
FROM Sales.Orders
